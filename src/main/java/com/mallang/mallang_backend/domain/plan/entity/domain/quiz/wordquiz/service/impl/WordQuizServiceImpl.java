package com.mallang.mallang_backend.domain.plan.entity.domain.quiz.wordquiz.service.impl;

import com.mallang.mallang_backend.domain.plan.entity.domain.member.entity.Member;
import com.mallang.mallang_backend.domain.plan.entity.domain.quiz.wordquiz.dto.WordQuizItem;
import com.mallang.mallang_backend.domain.plan.entity.domain.quiz.wordquiz.dto.WordQuizResponse;
import com.mallang.mallang_backend.domain.plan.entity.domain.quiz.wordquiz.dto.WordQuizResultSaveRequest;
import com.mallang.mallang_backend.domain.plan.entity.domain.quiz.wordquiz.dto.WordbookQuizResponse;
import com.mallang.mallang_backend.domain.plan.entity.domain.quiz.wordquiz.entity.WordQuiz;
import com.mallang.mallang_backend.domain.plan.entity.domain.quiz.wordquiz.repository.WordQuizRepository;
import com.mallang.mallang_backend.domain.plan.entity.domain.quiz.wordquiz.service.WordQuizService;
import com.mallang.mallang_backend.domain.plan.entity.domain.quiz.wordquizresult.entity.WordQuizResult;
import com.mallang.mallang_backend.domain.plan.entity.domain.quiz.wordquizresult.repository.WordQuizResultRepository;
import com.mallang.mallang_backend.domain.plan.entity.domain.video.subtitle.repository.SubtitleRepository;
import com.mallang.mallang_backend.domain.plan.entity.domain.voca.word.repository.WordRepository;
import com.mallang.mallang_backend.domain.plan.entity.domain.voca.wordbook.entity.Wordbook;
import com.mallang.mallang_backend.domain.plan.entity.domain.voca.wordbook.repository.WordbookRepository;
import com.mallang.mallang_backend.domain.plan.entity.domain.voca.wordbookitem.entity.WordStatus;
import com.mallang.mallang_backend.domain.plan.entity.domain.voca.wordbookitem.entity.WordbookItem;
import com.mallang.mallang_backend.domain.plan.entity.domain.voca.wordbookitem.repository.WordbookItemRepository;
