package com.mallang.mallang_backend.domain.plan.entity.domain.video.video.cache;

import com.mallang.mallang_backend.domain.plan.entity.domain.video.util.VideoUtils;
import com.mallang.mallang_backend.domain.plan.entity.domain.video.video.cache.dto.CachedVideos;
import com.mallang.mallang_backend.domain.plan.entity.domain.video.video.dto.SearchContext;
import com.mallang.mallang_backend.domain.plan.entity.domain.video.video.dto.VideoResponse;
import com.mallang.mallang_backend.domain.plan.entity.domain.video.youtube.config.VideoSearchProperties;
