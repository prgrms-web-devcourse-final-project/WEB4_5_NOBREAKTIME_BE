package com.mallang.mallang_backend.domain.plan.entity.domain.video.learning.service;
...
public interface VideoLearningQuizService {
	 ...
	 */
	VideoLearningExpressionQuizListResponse makeExpressionQuizList(String videoId);
}